<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="addque.aspx.cs" Inherits="addque" %>
...
<table style="width: 80%;">
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        ...
        <tr>
            <td colspan="2"><div class="article"><h1 style="color:White;">Add Security Question</h1></div>
            </td>
        </tr>
        <tr>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            AutoGenerateColumns="False" DataKeyNames="que_id" ShowFooter="True" 
        ...
        Width="600px" onrowcancelingedit="GridView1_RowCancelingEdit">
            <Columns>
                <asp:TemplateField HeaderText="Question Id">
                    <ItemTemplate>
                        <asp:Label ID="lblqid" runat="server" Text='<%#Eval("que_id") %>'>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="Question name">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtname" runat="server" Text='<%#Eval("Question") %>'>'></asp:TextBox>
                    </EditItemTemplate>
