<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="add_country.aspx.cs" Inherits="add_country" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 80%;">
        ...
        <tr>
            <td colspan="2"><div class="article"><h1 style="color:White;">Add Country</h1></div>
            </td>
        </tr>
        <tr>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            AutoGenerateColumns="False" DataKeyNames="country_id" ShowFooter="True" 
        ...
        Width="600px" onrowcancelingedit="GridView1_RowCancelingEdit">
            <Columns>
                <asp:TemplateField HeaderText="Country Id">
                    <ItemTemplate>
                        <asp:Label ID="lblcid" runat="server" Text='<%#Eval("country_id") %>'>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:Label ID="lblid" runat="server" Text='<%#Eval("country_id") %>'>'>></asp:Label>
                    </EditItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="Country name">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtname" runat="server" Text='<%#Eval("country_name") %>'>'></asp:TextBox>
                    </EditItemTemplate>
