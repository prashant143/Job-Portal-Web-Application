...
public partial class add_country : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            obj.ide("delete from country where country_id='" + id + "'");
            bind();
        }
        catch (Exception ex)
        {
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            obj.ide("update country set country_name='" + txtname.Text + "' where country_id='" + lblid.Text + "'");
    ...
    {
        int cnt;
        cnt = obj.nubmerofrow("select count(country_name) from country where country_name='" + TextBox1.Text + "'");
        if (cnt == 0)
        {
            obj.ide("insert into country values('" + TextBox1.Text + "')");
            TextBox1.Text = "";
            Label1.Text = "Country successfully Inserted";
        }
        else
        {
