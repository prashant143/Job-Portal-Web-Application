<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="add_city.aspx.cs" Inherits="add_city" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 80%;">
        ...
        <tr>
            <td colspan="2"><div class="article"><h1 style="color:White;">Add&nbsp; City</h1></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style1" style="font-size: medium; color: #008080">
                State Name:-</td>
            <td class="style2">
                <asp:DropDownList ID="ddlstate" runat="server" Height="27px" Width="200px">
                </asp:DropDownList>
        ...
        <tr>
            ...
            <td class="style2">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ErrorMessage="Enter city name" ControlToValidate="TextBox1" 
    ...
    <asp:Panel ID="pnlperpage" runat="server" Font-Bold="True" Font-Size="Medium" 
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;State Name:-&nbsp;<asp:DropDownList ID="ddlstate0" runat="server" 
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            AutoGenerateColumns="False" DataKeyNames="city_id" ShowFooter="True" 
        ...
        onselectedindexchanged="GridView1_SelectedIndexChanged">
            <Columns>
                <asp:TemplateField HeaderText="City Id">
                    <ItemTemplate>
                        <asp:Label ID="lblsid" runat="server" Text='<%#Eval("city_id") %>'>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="Country name">
                    ...
                    <EditItemTemplate>
                        <asp:Label ID="lblconame" runat="server" Text='<%#Eval("country_name") %>'>'></asp:Label>
                    </EditItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="State name">
                    ...
                    <EditItemTemplate>
                        <asp:Label ID="lblstname" runat="server" Text='<%#Eval("state_name") %>'>'></asp:Label>
                    </EditItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="City name">
                    <ItemTemplate>
                        <asp:Label ID="lblcname" runat="server" Text='<%#Eval("city_name") %>'>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txtcname" runat="server" Text='<%#Eval("city_name") %>'>'></asp:TextBox>
                    </EditItemTemplate>
