<%@ Page Title="" Language="C#" MasterPageFile="~/jobseeker.master" AutoEventWireup="true" CodeFile="company_qrystr.aspx.cs" Inherits="company_qrystr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td align="center" colspan="2"><div class="article"><h1 style="color:White; font-family:Arial;">Company Detail</h1></div></td>
    </tr>
    <tr>
        <td style="width:35%;">
